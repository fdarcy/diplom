...
5. Посмотреть значение в столбце "id"
6. В DBeaver открыть "order_entity"
7. Посмотреть значение в столбце "credit_id"
8. Сравнить "id" и "credit_id"  
   Ожидаемый результат   
   Значение столбца "id" в таблице "credit_request_entity" совпадает со значением столбца "credit_id" в таблице "order_entity" 
